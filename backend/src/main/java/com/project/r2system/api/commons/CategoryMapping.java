...
import com.project.r2system.domain.data.payloads.CategoryResponse;
...
public class CategoryMapping {
    ...
    public void updateCategoryByResponse(CategoryResponse categoryResponse, Category category){
