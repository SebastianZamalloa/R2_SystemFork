...
public class ArticleMapping {
    ...
    public ArticleResponse mapArticleToResponse(Article article) {
    ...
    public Article createArticleByResponse(ArticleResponse articleResponse){
    ...
    public void updateArticleByResponse(ArticleResponse articleResponse, Article article){
